...
def main(args):
    ...
    for i in folds:
        ...
        results, val_auc, val_acc  = train(datasets, i, args)
    ...
    final_df = pd.DataFrame({'folds': folds, 'val_auc': all_val_auc, 'val_acc' : all_val_acc})
...
parser.add_argument('--task', type=str, choices=['task_1_M', 'task_2_HE', 'task_3_CD4', 'task_4_CD8',
                                                'task_5_CD20', 'task_6_CD56', 'task_7_CD68', 'task_8_CD163', 
                                                'task_9_FOXP3', 'task_10_PDL1', 'task_11_M4', 'task_12_M2'])
...
if args.model_type in ['clam_sb', 'clam_mb', 'msdlm', 'mscl_sb', 'mscl_mb']:
